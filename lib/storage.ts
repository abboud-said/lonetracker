...
export function defaultState(): AppState {
  return {
    settings: {
      ...
      breakIsPaid: false,
      semesterPayPerDay: 0,
      semesterPayEstimated: false,
      semesterersattningMonthly: false,
      weeklyHours: 0,
    },
  ...
  try {
    ...
    return {
      settings: {
        ...
        semesterPayEstimated: parsed.settings?.semesterPayEstimated === true,
        semesterersattningMonthly: parsed.settings?.semesterersattningMonthly === true,
